...
require_once(dirname(__FILE__).'/scripts/tableClass/email_table.php'); 
require_once(dirname(__FILE__).'/scripts/tableClass/mailings_table.php'); 
...
function wga_plugin_setup_menu(){
	...
	if(function_exists('add_submenu_page')){
		...
		add_action( "load-$mailings_page_hook", [ WGA_Manage_Mailings::get_instance(), 'screen_option' ] );
		add_action( "load-$email_page_hook", [ WGA_Manage_Email::get_instance(), 'screen_option' ] );
